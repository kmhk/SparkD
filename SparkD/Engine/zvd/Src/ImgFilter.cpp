                                                   ...
                                                   int symmetryType )
{
    ...
    {
        if( sdepth == MAT_Tuchar && ddepth == MAT_Tint )
    ...
    if( sdepth == MAT_Tuchar && ddepth == MAT_Tfloat )
        return Ptr<BaseRowFilter>(new RowFilter<uchar, float, RowNoVec>(kernel, anchor));
    if( sdepth == MAT_Tuchar && ddepth == MAT_Tdouble )
                                             ...
                                             int bits )
{
    ...
    {
        if( ddepth == MAT_Tuchar && sdepth == MAT_Tint )
...
void preprocess2DKernel( const Mat& kernel, vector<Point>& coords, vector<uchar>& coeffs )
{
    ...
    if(nz == 0)
        nz = 1;
    assert( ktype == MAT_Tuchar || ktype == MAT_Tint || ktype == MAT_Tfloat || ktype == MAT_Tdouble );
    coords.resize(nz);
                                ...
                                double delta, int bits)
{
    ...
    if( sdepth == MAT_Tuchar && ddepth == MAT_Tuchar )
    ...
    if( sdepth == MAT_Tuchar && ddepth == MAT_Tshort )
